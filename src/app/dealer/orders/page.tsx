      ...
      <div className="max-h-[92vh] w-full max-w-4xl overflow-y-auto rounded-3xl bg-white shadow-2xl">
        ...
        <div className="space-y-6 p-5 sm:p-6">
          <div className="flex flex-wrap gap-2">
            ...
            <span
              className={`rounded-full px-3 py-1 text-xs font-bold ${paymentClass(
                order.payment_status,
              )}`}
            >
              {label(
          ...
          <div className="flex flex-col gap-2 border-t border-slate-200 pt-5 sm:flex-row sm:justify-end">
            ...
            {next ? (
              <button
                ...
                className="inline-flex h-11 items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 text-sm font-bold text-white transition hover:bg-blue-700 disabled:opacity-50"
              >
                {processing ? (
